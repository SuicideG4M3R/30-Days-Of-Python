...
print('Nombre :', data.count()) # 25
print('Somme : ', data.sum()) # 744
print('Min : ', data.min()) # 24
print('Max : ', data.max()) # 38
print('Étendue : ', data.range()) # 14
print('Moyenne : ', data.mean()) # 30
print('Médiane : ', data.median()) # 29
print('Mode : ', data.mode()) # {'mode': 26, 'count': 5}
print('Écart type : ', data.std()) # 4.2
print('Variance : ', data.var()) # 17.5
print('Distribution de fréquence : ', data.freq_dist()) # [(20.0, 26), (16.0, 27), (12.0, 32), (8.0, 37), (8.0, 34), (8.0, 33), (8.0, 31), (8.0, 24), (4.0, 38), (4.0, 29), (4.0, 25)]
```
...
Variance :  17.5
Écart type :  4.2
Distribution de fréquence : [(20.0, 26), (16.0, 27), (12.0, 32), (8.0, 37), (8.0, 34), (8.0, 33), (8.0, 31), (8.0, 24), (4.0, 38), (4.0, 29), (4.0, 25)]
```
