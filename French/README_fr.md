...
[![Installer sur Windows](.././images/installing_on_windows.png)](https://www.python.org/)

Si vous utilisez macOS, cliquez sur le bouton correspondant.

[![Installer sur macOS](.././images/installing_on_macOS.png)](https://www.python.org/)
...
![Version de Python](../images/python_versio.png)
...
![Script Python dans le shell](../images/adding_on_python_shell.png)
...
![Quitter le shell Python](../images/exit_from_shell.png)
...
![Correction d'erreur de syntaxe](../images/fixing_syntax_error.png)
...
![Opérations dans le shell Python](../images/maths_on_python_shell.png)
...
![Écrire une chaîne dans le shell Python](../images/writing_string_on_shell.png)
...
![Ouvrir un projet dans Visual Studio](../images/how_to_open_project_on_vscode.png)

![Ouvrir un projet](../images/opening_project.png)
...
![Erreur d'indentation](../images/indentation.png)
...
![Vérification des types de données](../images/checking_data_types.png)
...
![Exécution d'un script Python](../images/running_python_script.png)
